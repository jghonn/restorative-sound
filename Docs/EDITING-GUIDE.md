...
|---------|---------------|
| **Site Settings & Copy → General & Contact** | The three logo slots (header, hero, footer — each its own file; transparent-background, single-color PNGs), tagline, email, phone, Instagram link |
...
| **Site Settings & Copy → Footer** | The copyright line (the © and year are automatic) and the email shown in the footer |
